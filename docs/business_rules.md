...
- Data não pode ser maior que a data de hoje
- Animal abatido não pode registrar produção
- Animal vendido não pode registrar produção
- Animal macho não pode registrar produção
